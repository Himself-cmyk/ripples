...
!function(e, t) {
    ...
    function o(e, r, i) {
        ...
        var n = {};
        if (n.id = t.createProgram(),
        t.attachShader(n.id, o(t.VERTEX_SHADER, e)),
        t.attachShader(n.id, o(t.FRAGMENT_SHADER, r)),
        t.linkProgram(n.id),
        !t.getProgramParameter(n.id, t.LINK_STATUS))
            throw new Error("link error: " + t.getProgramInfoLog(n.id));
        n.uniforms = {},
        n.locations = {},
        t.useProgram(n.id),
        t.enableVertexAttribArray(0);
        for (var a, s, u = /uniform (\w+) (\w+)/g, h = e + r; null != (a = u.exec(h)); )
            s = a[2],
            n.locations[s] = t.getUniformLocation(n.id, s);
        return n
    }
    function n(e, r) {
    ...
    var s = function() {
        ...
        i.push(o("float", t.FLOAT, Float32Array)),
        r.OES_texture_half_float && i.push(o("half_float", r.OES_texture_half_float.HALF_FLOAT_OES, null));
        ...
        for (var s = null, u = 0; u < i.length; u++)
            if (t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, 32, 32, 0, t.RGBA, i[u].type, null),
    ...
    var h = function(r, i) {
        ...
        for (var a = s.arrayType, u = a ? new a(this.resolution * this.resolution * 4) : null, h = 0; h < 2; h++) {
            ...
            t.bindFramebuffer(t.FRAMEBUFFER, c),
    ...
    h.prototype = {
        ...
        computeTextureBoundaries: function() {
            ...
            e.height = r.height()) : ((e = this.$el.offset()).width = this.$el.innerWidth(),
            ...
            "cover" == t)
                ...
                a = Math.min(e.width / this.backgroundWidth, e.height / this.backgroundHeight),
                s = this.backgroundWidth * a,
                u = this.backgroundHeight * a;
            else {
                s = (t = t.split(" "))[0] || "",
            ...
            var h = n[0]
              , d = n[1];
            h = i(h) ? e.left + (e.width - s) * parseFloat(h) / 100 : e.left + parseFloat(h),
            d = i(d) ? e.top + (e.height - u) * parseFloat(d) / 100 : e.top + parseFloat(d);
            var c = this.$el.offset();
            this.renderProgram.uniforms.topLeft = new Float32Array([(c.left - h) / s, (c.top - d) / u]),
